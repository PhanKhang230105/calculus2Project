...
% Khang thêm phần lý thuyết vào đây nhen
%\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
...
and
\begin{equation}
    \int_C Qdy=\iint_{D} \dfrac{\partial Q}{\partial x}dA
\end{equation}
\begin{center}
...
%Straight Lines [id:da19430905107742658] 
\draw    (300,40.23) -- (300,263.44) ;
\draw [shift={(300,38.23)}, rotate = 90] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da4287073773589094] 
\draw    (176.99,220.01) -- (698.6,219.06) ;
\draw [shift={(700.6,219.06)}, rotate = 179.9] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da8447345131231538] 
\draw    (372,85.23) -- (372,180.44) ;
\draw [shift={(372,137.84)}, rotate = 270] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
%Straight Lines [id:da11142857371682324] 
\draw    (562,105.23) -- (562,160.44) ;
\draw [shift={(562,126.34)}, rotate = 90] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
%Curve Lines [id:da8576864478185466] 
\draw    (372,85.23) .. controls (412,55.23) and (525.6,112.84) .. (562,105.23) ;
\draw [shift={(461.52,85.12)}, rotate = 14.02] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
%Curve Lines [id:da27638538117476585] 
\draw    (372,180.44) .. controls (423.6,196.84) and (522,190.44) .. (562,160.44) ;
\draw [shift={(474.59,187.53)}, rotate = 174.68] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
%Straight Lines [id:da2767488562612568] 
\draw    (372,213.23) -- (372,224.44) ;
%Straight Lines [id:da1819184811930914] 
\draw    (562,214.23) -- (562,225.44) ;

% Text Node
\draw (696.24,198.16) node [anchor=north west][inner sep=0.75pt]    {$x$};
% Text Node
\draw (304.64,35.56) node [anchor=north west][inner sep=0.75pt]    {$y$};
% Text Node
\draw (520.24,185.16) node [anchor=north west][inner sep=0.75pt]    {$C_{1}$};
% Text Node
\draw (574.24,121.16) node [anchor=north west][inner sep=0.75pt]    {$C_{2}$};
% Text Node
\draw (473.24,56.16) node [anchor=north west][inner sep=0.75pt]    {$C_{3}$};
% Text Node
\draw (338.24,118.16) node [anchor=north west][inner sep=0.75pt]    {$C_{4}$};
% Text Node
\draw (367.24,222.16) node [anchor=north west][inner sep=0.75pt]    {$a$};
% Text Node
\draw (555.24,225.16) node [anchor=north west][inner sep=0.75pt]    {$b$};
